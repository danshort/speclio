...
## Requirements
### Requirement: Loading project specs
...
#### Scenario: Order of sections on screen
...
#### Scenario: Enter on a spec activates viewing
...
#### Scenario: Expanded state does not affect the cursor of another spec
...
#### Scenario: Expand state resets when re-entering the index
...
#### Scenario: j/k traverses the requirements of an expanded spec
...
### Requirement: Cursor snap when collapsing a spec with an interior cursor
...
#### Scenario: Collapse a spec with the cursor on a requirement
...
#### Scenario: Collapsing a spec without an interior cursor does not move the cursor
