...
#### Scenario: Directory with a simple name
- **WHEN** the CWD is `/home/user/my-project`
- **THEN** the project name is `"my-project"`

### Requirement: Reread a change's artifacts from disk
...
### Requirement: Sort active changes by creation date
...
#### Scenario: Changes with different dates
...
#### Scenario: Undated changes go last
...
#### Scenario: Changes with the same date
